    ...
    return (
      <div className="h-screen w-screen bg-purpleHearth dark:bg-bunting flex flex-col gap-y-5 items-center justify-center">
        <div className="flex flex-col justify-center items-center">
          <span className="text-center text-sulu font-bold text-5xl pb-5">{notFound[0]}</span>
          <span className="text-center text-bilobaFlower text-2xl pb-3">{notFound[1]}</span>
          <span className="text-center text-malibu text-lg">{notFound[2]}</span>
        </div>
